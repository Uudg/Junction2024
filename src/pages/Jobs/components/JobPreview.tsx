...
const JobPreview = ({ job, select, bgColor }: any) => {
    ...
    return (
        <div className="gap-2 flex bg-zinc-100 p-2 border border-slate-300 rounded-3xl md:flex-row">
            <div
            ...
            >
                ...
                <div className="flex justify-between gap-2">
                    ...
                    <div className="bg-white aspect-square shrink-0 rounded-full h-10 flex items-center justify-center">
                        {job.company_logo ? (
                            <img
            ...
            <div className="flex flex-col justify-between p-4 md:px-2 md:items-start items-center w-1/2">
                <div className="flex flex-row w-full justify-between gap-2">
                    <div className="flex flex-col mb-4 whitespace-nowrap">
                    ...
                    <div className="flex gap-2 flex-wrap w-full">
                        {job.perks.map((el: any, index: number) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className="rounded-full px-2 text-sm h-fit font-light border border-gray-400 py-2"
                                >
                                    {capitalize(el)}
                                </div>
                            );
